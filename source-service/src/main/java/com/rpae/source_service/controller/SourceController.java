...
public class SourceController {
	...
	@GetMapping("/getAllCryptoCoins")
	public CompletableFuture<List<CryptoCoinDTO>> getAllCryptoCoins(@RequestParam String vs_currency) {
		String url = String.format(Constants.CRYPTO_API_URL, vs_currency);
